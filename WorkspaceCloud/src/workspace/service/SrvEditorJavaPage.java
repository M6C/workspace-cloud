...
import framework.ressource.util.UtilDecoder;
        ...
        try {
          if (UtilString.isNotEmpty(application)) {
            ...
            if (filePathMain!=null && !filePathMain.equals("")) {
	            ...
	            //request.setAttribute("pathToExpand", UtilDecoder.decodeHTMLEntities((String)bean.getParameterDataByName("pathToExpand")));
            }
          }
        }
