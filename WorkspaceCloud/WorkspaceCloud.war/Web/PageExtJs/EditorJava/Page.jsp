...
<head>
  <title>Complex Layout</title>
    <link rel="stylesheet" type="text/css" href="/essai/jsFramework/extjs/resources/css/ext-all.css" />
    ...
    .proj {
        background-image:url(/essai/jsFramework/extjs/examples/shared/icons/fam/cog.png);
    }
    .dir {
        background-image:url(/essai/jsFramework/extjs/examples/shared/icons/fam/folder_go.png);
    }
    .file {
        background-image:url(/essai/jsFramework/extjs/examples/shared/icons/fam/book.png);
    }
    </style>

    <!-- GC -->
    <!-- LIBS -->
    <script type="text/javascript" src="/essai/jsFramework/extjs/adapter/ext/ext-base.js"></script>
    <!-- ENDLIBS -->

    <script type="text/javascript" src="/essai/jsFramework/extjs/ext-all.js"></script>

    <!-- EXAMPLES -->
    <script type="text/javascript" src="/essai/jsFramework/extjs/examples/shared/examples.js"></script>
        ...
        var viewport = new Ext.Viewport({
            ...
            new Ext.BoxComponent({
                ...
                items: [{
                    ...
                    title: 'Project',
                    border: false,
                    iconCls: 'proj' // see the HEAD section for style used
                }, {
...
<body>
    ...
    <div id="west-project" class="x-hide-display">
        ...
        <jsp:include page="/Web/ComponentExtJs/TreeView/TreeViewDir.jsp" flush="true">
