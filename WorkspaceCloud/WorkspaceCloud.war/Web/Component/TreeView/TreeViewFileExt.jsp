	...
	<td>
		<file:TagFileList path="#R$pathTreeViewFileExt#" pathToExpand="" sortMethod="getName">
			...
			<%if (((framework.taglib.file.bean.BeanFile)request.getAttribute("myFile")).isFile()) {%>
				...
				<html:TagA attrHref="javascript:openPopup('action.servlet?event=PageFileEditor&FileName=#R$myFile.File.toURI.getPath#', 'PageFileEditor', 750, 630)"><img unselectable="on" width="15" height="15" class="memoOut" align="absmiddle" src="/img/Common/file_editor.gif" onmouseover="this.className='memoOver';" onmouseout="this.className='memoOut';" title="File editor"/></html:TagA>
				<html:TagA attrHref="javascript:openPopup('action.servlet?event=EditorJavaPageDelete&fileName=#R$myFile.File.toURI.getPath#', 'EditorJavaPageDelete', 320, 120)"><img unselectable="on" width="15" height="15" class="memoOut" align="absmiddle" src="/img/Editor/ed_del_file.gif" onmouseover="this.className='memoOver';" onmouseout="this.className='memoOut';" title="Delete File"/></html:TagA>
				<html:TagA attrHref="javascript:openPopup('action.servlet?event=EditorJavaPageRename&oldName=#R$myFile.File.toURI.getPath#&newName=#R$myFile.File.toURI.getPath#', 'EditorJavaPageRename', 320, 120)"><img unselectable="on" width="15" height="15" class="memoOut" align="absmiddle" src="/img/Editor/ed_rename_file.gif" onmouseover="this.className='memoOver';" onmouseout="this.className='memoOut';" title="Rename File"/></html:TagA>
				<html:TagA attrHref="javascript:openPopup('action.servlet?event=EditorJavaPageCopyMove&pathSrc=#R$myFile.File.toURI.getPath#&pathDst=#R$myFile.File.toURI.getPath#&path=#R$path#&type=file', 'EditorJavaPageCopyMove', 390, 150)"><img unselectable="on" width="15" height="15" class="memoOut" align="absmiddle" src="/img/Editor/ed_copy_move_dir.gif" onmouseover="this.className='memoOver';" onmouseout="this.className='memoOut';" title="Copy/Move Directory"/></html:TagA>
				</td><td>
