...
<table class="treeview">
    <tr class="treeview">
        <td class="treeviewTopLeft"><IMG class="BorderTopRight" src="/img/TreeView/b.gif"></td>
    ...
    <request:TagDefineCount name="count" scope="request"/>
                                ...
                                <tr class="treeviewFileList<%if ((Integer.parseInt((String)request.getAttribute("count"))%2)==0) {%>Colored<%}%>">
                                    <td class="treeviewFileList">
                                            ...
                                            <img src="/img/TreeView/ot0.gif" width="18" height="18" border="0" align="top"/>
                                    </td>
                                    <td class="treeviewFileList">
                                    ...
                                    <td class="treeviewFileList">
                                        <html:TagA attrHref="javascript:openPopup('action.servlet?event=PageFileEditor&application=#R$application#&pathToExpand=#R$pathToExpand#&FileName=#R$myFile.getPathUriRelative<encoding=UTF-8>#', 'PageFileEditor', 750, 630)"><img unselectable="on" width="15" height="15" class="buttonOut" align="absmiddle" src="/img/Common/file_editor.gif" onmouseover="this.className='buttonOver';" onmouseout="this.className='buttonOut';" title="File editor"/></html:TagA>
                                        <html:TagA attrHref="javascript:openPopup('action.servlet?event=EditorJavaPageDelete&application=#R$application#&fileName=#R$pathToExpand##R$myFile.getPathUriRelative<encoding=UTF-8>#', 'EditorJavaPageDelete', 320, 120)"><img unselectable="on" width="15" height="15" class="buttonOut" align="absmiddle" src="/img/Editor/ed_del_file.gif" onmouseover="this.className='buttonOver';" onmouseout="this.className='buttonOut';" title="Delete File"/></html:TagA>
                                        <html:TagA attrHref="javascript:openPopup('action.servlet?event=EditorJavaPageRename&application=#R$application#&oldName=#R$pathToExpand##R$myFile.getPathUriRelative<encoding=UTF-8>#&newName=#R$pathToExpand##R$myFile.getPathUriRelative<encoding=UTF-8>#', 'EditorJavaPageRename', 320, 120)"><img unselectable="on" width="15" height="15" class="buttonOut" align="absmiddle" src="/img/Editor/ed_rename_file.gif" onmouseover="this.className='buttonOver';" onmouseout="this.className='buttonOut';" title="Rename File"/></html:TagA>
                                        <html:TagA attrHref="javascript:openPopup('action.servlet?event=EditorJavaPageCopyMove&application=#R$application#&pathSrc=#R$pathToExpand##R$myFile.getPathUriRelative<encoding=UTF-8>#&pathDst=#R$pathToExpand##R$myFile.getPathUriRelative<encoding=UTF-8>#&path=&type=file', 'EditorJavaPageCopyMove', 390, 150)"><img unselectable="on" width="15" height="15" class="buttonOut" align="absmiddle" src="/img/Editor/ed_copy_move_dir.gif" onmouseover="this.className='buttonOver';" onmouseout="this.className='buttonOut';" title="Copy/Move Directory"/></html:TagA>
                                        <html:TagA attrHref="javascript:openPopup('action.servlet?event=AdminStreaming&application=#R$application#&path=#R$pathToExpand#&filename=#R$myFile.getPathUriRelative<encoding=UTF-8>#', 'AdminStreaming', 390, 150)"><img unselectable="on" width="15" height="15" class="buttonOut" align="absmiddle" src="/img/Editor/ed_copy_move_dir.gif" onmouseover="this.className='buttonOver';" onmouseout="this.className='buttonOut';" title="Streaming"/></html:TagA>
                                    </td>
