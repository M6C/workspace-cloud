...
<html>
    <head>
        <title>
	        ...
	        <link href="/css/page/versioning/pagecommit.css" rel="stylesheet" type="text/css">
		<script language="javascript" src="/js/page/versioning/pagecommit.js" type="text/javascript"></script>
	</head>
	<body>
