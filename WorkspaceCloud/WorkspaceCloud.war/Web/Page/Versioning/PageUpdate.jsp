...
<html>
    <head>
        <title>
	        ...
	        <link href="/css/page/versioning/pageupdate.css" rel="stylesheet" type="text/css">
		<script language="javascript" src="/js/page/versioning/pageupdate.js" type="text/javascript"></script>
	</head>
	<body>
