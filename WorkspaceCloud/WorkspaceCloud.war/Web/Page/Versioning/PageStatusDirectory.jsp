...
<html>
    <head>
        <title>
	        ...
	        <link href="/css/page/versioning/pagestatusdirectory.css" rel="stylesheet" type="text/css">
		<script language="javascript" src="/js/page/versioning/pagestatusdirectory.js" type="text/javascript"></script>
	</head>
	<body>
