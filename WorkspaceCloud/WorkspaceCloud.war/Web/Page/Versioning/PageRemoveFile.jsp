...
<html>
	<head>
		<title>
	        ...
	        <link href="/css/page/versioning/pageremovefile.css" rel="stylesheet" type="text/css">
		<script language="javascript" src="/js/page/versioning/pageremovefile.js" type="text/javascript"></script>
	</head>
	<body>
