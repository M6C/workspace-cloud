...
<html>
    <head>
        <title>
	        ...
	        <link href="/css/page/versioning/pagecommitdirectory.css" rel="stylesheet" type="text/css">
		<script language="javascript" src="/js/page/versioning/pagecommitdirectory.js" type="text/javascript"></script>
	</head>
	<body>
