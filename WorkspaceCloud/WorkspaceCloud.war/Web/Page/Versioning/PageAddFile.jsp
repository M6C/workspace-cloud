...
<html>
	<head>
		<title>
	        ...
	        <link href="/css/page/versioning/pageaddfile.css" rel="stylesheet" type="text/css">
		<script language="javascript" src="/js/page/versioning/pageaddfile.js" type="text/javascript"></script>
	</head>
	<body>
