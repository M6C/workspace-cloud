...
<html>
	<head>
		<title>
	        ...
	        <link href="/css/page/versioning/pageignoreadd.css" rel="stylesheet" type="text/css">
		<script language="javascript" src="/js/page/versioning/pageignoreadd.js" type="text/javascript"></script>
	</head>
	<body>
