...
<html>
	<head>
		<title>
	        ...
	        <link href="/css/page/versioning/pageadddirectory.css" rel="stylesheet" type="text/css">
		<script language="javascript" src="/js/page/versioning/pageadddirectory.js" type="text/javascript"></script>
	</head>
	<body>
