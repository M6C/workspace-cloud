...
<html>
    <head>
        <title>
	        ...
	        <link href="/css/page/versioning/pageupdfile.css" rel="stylesheet" type="text/css">
		<script language="javascript" src="/js/page/versioning/pageupdfile.js" type="text/javascript"></script>
	</head>
	<body>
