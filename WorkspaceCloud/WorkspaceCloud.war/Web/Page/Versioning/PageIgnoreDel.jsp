...
<html>
	<head>
		<title>
	        ...
	        <link href="/css/page/versioning/pageignoredel.css" rel="stylesheet" type="text/css">
		<script language="javascript" src="/js/page/versioning/pageignoredel.js" type="text/javascript"></script>
	</head>
	<body>
