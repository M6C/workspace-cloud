...
--%>
    	...
    	<link href="/css/page/imageviewer/page.css" rel="stylesheet" type="text/css">
        <script language="javascript" src="/js/page/common/function.js" type="text/javascript"></script>
        <script language="javascript" src="/js/page/imageviewer/page.js" type="text/javascript"></script>
