...
<html>
    <head>
        ...
        <title>
            ...
            <link href="/css/page/common/pageupload.css" rel="stylesheet" type="text/css"/>
        <script language="javascript" src="/js/page/common/pageupload.js" type="text/javascript"></script>
    </head>
