...
<html>
	<head>
		<title>
	        ...
	        <link href="/css/page/common/pagenew.css" rel="stylesheet" type="text/css"/>
		<script language="javascript" src="/js/page/common/pagenew.js" type="text/javascript"></script>
	</head>
