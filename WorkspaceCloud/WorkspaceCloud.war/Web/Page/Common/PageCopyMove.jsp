...
<html>
	<head>
		<title>
	        ...
	        <link href="/css/page/common/pagecopymove.css" rel="stylesheet" type="text/css"/>
		<script language="javascript" src="/js/page/common/pagecopymove.js" type="text/javascript"></script>
