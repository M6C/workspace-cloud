...
<html>
    <head>
        <title>
            ...
            <link href="/css/page/common/pagedelete.css" rel="stylesheet" type="text/css"/>
        <script language="javascript" src="/js/page/common/pagedelete.js" type="text/javascript"></script>
    </head>
