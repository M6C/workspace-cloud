...
<html>
    <head>
        <title>
	        ...
	        <link href="/css/page/common/pagerename.css" rel="stylesheet" type="text/css"/>
		<script language="javascript" src="/js/page/common/pagerename.js" type="text/javascript"></script>
    </head>
