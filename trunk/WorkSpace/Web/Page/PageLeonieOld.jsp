...
<br>
<%
  String szPathImg = "/WorkSpace/Photos/Leonie/";
...
<%
    ...
    if(end>0) {
        ...
        for( int i=0 ; i<end ; i++ )
        {
%>        <TD><%=((i==index) ? "<b>" : "")%><A HREF="action.servlet?event=PageLeonie&path=/Dev/Travaux/Java/JBuilder8/WorkSpace/WorkSpace/Photos&index=<%=i%>"><%=i+1%><%=((i==index) ? "</b>" : "")%></A></TD><%
        }
